...
export class AppComponent implements OnInit {
    ...
    constructor(private readonly angulartics2GoogleGlobalSiteTag : Angulartics2GoogleGlobalSiteTag, private _renderer2 : Renderer2, @Inject(DOCUMENT)private _document : Document, private readonly title : Title, private readonly media : MediaMatcher) {
